...
{
    /// <summary>
    /// This inteface provides the interface definition for all callback methids supported by Enterprise Architect
    ...
    public interface  IAddin
    {
        ...
        /// <param name="Repository">An EA.Repository object representing the currently open Enterprise Architect model.
        /// Poll its members to retrieve model data and user interface status information.</param>
        /// <param name="Location">String representing the part of the user interface that brought up the menu. 
        /// Can be TreeView, MainMenu or Diagram.</param>
        ...
        [OperationContract]
        void EA_OnOutputItemClicked(EA.Repository Repository, string TabName, string LineText, long ID);
        ...
        /// <param name="ID">The ID value specified in the original call to Repository.WriteOutput().</param>
        [OperationContract]
        void EA_OnOutputItemDoubleClicked(EA.Repository Repository, string TabName, string LineText, long ID);
        ...
        /// Poll its members to retrieve model data and user interface status information.</param>
        [OperationContract]
        void EA_FileNew(EA.Repository Repository);
        ...
        [OperationContract]
        void EA_OnPostCloseDiagram(EA.Repository Repository, int DiagramID);
        ...
        [OperationContract]
        void EA_OnPostOpenDiagram(EA.Repository Repository, int DiagramID);
        ...
        [OperationContract]
        bool EA_OnPreDeleteElement(EA.Repository Repository, EA.EventProperties Info);
        ...
        [OperationContract]
        bool EA_OnPreDeleteAttribute(EA.Repository Repository, EA.EventProperties Info);
        ...
        [OperationContract]
        bool EA_OnPreDeleteMethod(EA.Repository Repository, EA.EventProperties Info);
        ...
        [OperationContract]
        bool EA_OnPreDeleteConnector(EA.Repository Repository, EA.EventProperties Info);
        ...
        [OperationContract]
        bool EA_OnPreDeleteDiagram(EA.Repository Repository, EA.EventProperties Info);
        ...
        [OperationContract]
        bool EA_OnPreDeletePackage(EA.Repository Repository, EA.EventProperties Info);
        ...
        [OperationContract]
        bool EA_OnPreDeleteGlossaryTerm(EA.Repository Repository, EA.EventProperties Info);
        ...
        [OperationContract]
        bool EA_OnPreNewElement(EA.Repository Repository, EA.EventProperties Info);
        ...
        [OperationContract]
        bool EA_OnPreNewConnector(EA.Repository Repository, EA.EventProperties Info);
        ...
        [OperationContract]
        bool EA_OnPreNewDiagram(EA.Repository Repository, EA.EventProperties Info);
        ...
        [OperationContract]
        bool EA_OnPreNewDiagramObject(EA.Repository Repository, EA.EventProperties Info);
        ...
        [OperationContract]
        bool EA_OnPreNewAttribute(EA.Repository Repository, EA.EventProperties Info);
        ...
        [OperationContract]
        bool EA_OnPreNewMethod(EA.Repository Repository, EA.EventProperties Info);
        ...
        [OperationContract]
        bool EA_OnPreNewPackage(EA.Repository Repository, EA.EventProperties Info);
        ...
        [OperationContract]
        bool EA_OnPreNewGlossaryTerm(EA.Repository Repository, EA.EventProperties Info);
        ...
        /// Poll its members to retrieve model data and user interface status information.</param>
        [OperationContract]
        void EA_OnPreExitInstance(EA.Repository Repository);
        ...
        [OperationContract]
        bool EA_OnPostNewElement(EA.Repository Repository, EA.EventProperties Info);
        ...
        [OperationContract]
        bool EA_OnPostNewConnector(EA.Repository Repository, EA.EventProperties Info);
        ...
        [OperationContract]
        bool EA_OnPostNewDiagram(EA.Repository Repository, EA.EventProperties Info);
        ...
        /// <returns>Return True if the element has been updated during this notification. Return False otherwise.</returns>
        [OperationContract]
        bool EA_OnPostNewDiagramObject(EA.Repository Repository, EA.EventProperties Info);
        ...
        [OperationContract]
        bool EA_OnPostNewAttribute(EA.Repository Repository, EA.EventProperties Info);
        ...
        [OperationContract]
        bool EA_OnPostNewMethod(EA.Repository Repository, EA.EventProperties Info);
        ...
        [OperationContract]
        bool EA_OnPostNewPackage(EA.Repository Repository, EA.EventProperties Info);
        ...
        [OperationContract]
        bool EA_OnPostNewGlossaryTerm(EA.Repository Repository, EA.EventProperties Info);
        ...
        /// Poll its members to retrieve model data and user interface status information.</param>
        [OperationContract]
        void EA_OnPostInitialized(EA.Repository Repository);
        ...
        [OperationContract]
        bool EA_OnPostTransform(EA.Repository Repository, EA.EventProperties Info);
        ...
        [OperationContract]
        bool EA_OnPreActivateTechnology(EA.Repository Repository, EA.EventProperties Info);
        ...
        [OperationContract]
        bool EA_OnPostActivateTechnology(EA.Repository Repository, EA.EventProperties Info);
        ...
        /// <param name="ot">Specifies the type of the new context item.</param>
        [OperationContract]
        void EA_OnNotifyContextItemModified(EA.Repository Repository, string GUID, EA.ObjectType ot);
        ...
        [OperationContract]
        object EA_QueryAvailableCompartments(EA.Repository Repository);
        ...
        [OperationContract]
        object EA_GetCompartmentData(EA.Repository Repository, string sCompartment, string sGUID, EA.ObjectType oType);
        ...
        /// Poll its members to retrieve model data and user interface status information.</param>
        [OperationContract]
        void EA_OnInitializeUserRules(EA.Repository Repository);
        ...
        [OperationContract]
        void EA_OnStartValidation(EA.Repository Repository, object Args);
        ...
        [OperationContract]
        void EA_OnEndValidation(EA.Repository Repository, object Args);
        ...
        [OperationContract]
        void EA_OnRunElementRule(EA.Repository Repository, string RuleID, EA.Element Element);
        ...
        [OperationContract]
        void EA_OnRunPackageRule(EA.Repository Repository, string RuleID, long PackageID);
        ...
        [OperationContract]
        void EA_OnRunDiagramRule(EA.Repository Repository, string RuleID, long DiagramID);
        ...
        [OperationContract]
        void EA_OnRunConnectorRule(EA.Repository Repository, string RuleID, long ConnectorID);
        ...
        [OperationContract]
        void EA_OnRunAttributeRule(EA.Repository Repository, string RuleID, string AttributeGUID, long ObjectID);
        ...
        [OperationContract]
        void EA_OnRunMethodRule(EA.Repository Repository, string RuleID, string MethodGUID, long ObjectID);
        ...
        [OperationContract]
        void EA_OnRunParameterRule(EA.Repository Repository, string RuleID, string ParameterGUID, string MethodGUID, long ObjectID);
        ...
        [OperationContract]
        void EA_OnAttributeTagEdit(EA.Repository Repository, long AttributeID, ref string TagName, ref string TagValue, ref string TagNotes);
        ...
        /// <param name="TagValue">The current value of the tag; if the value is updated, 
        /// the new value is stored in the repository on exit of the function.</param>
        /// <param name="TagNotes">The current value of the Tagged Value notes; if the value </param>
        [OperationContract]
        void EA_OnConnectorTagEdit(EA.Repository Repository, long ConnectorID, ref string TagName, ref string TagValue, ref string TagNotes);
        ...
        /// <param name="TagNotes">The current value of the Tagged Value notes; if the value </param>
        [OperationContract]
        void EA_OnElementTagEdit(EA.Repository Repository, long ObjectID, ref string TagName, ref string TagValue, ref string TagNotes);
        ...
        /// <param name="TagNotes">The current value of the Tagged Value notes; if the value </param>
        [OperationContract]
        void EA_OnMethodTagEdit(EA.Repository Repository, long MethodID, ref string TagName, ref string TagValue, ref string TagNotes);
        #endregion
        ...
        [OperationContract]
        string EA_OnRetrieveModelTemplate(EA.Repository Repository, string sLocation);
        ...
        [OperationContract]
        void MDG_BuildProject(EA.Repository Repository, string PackageGuid);
        ...
        [OperationContract]
        long MDG_Connect(EA.Repository Repository, long PackageID, string PackageGuid);
        ...
        [OperationContract]
        long MDG_Disconnect(EA.Repository Repository, string PackageGuid);
        ...
        [OperationContract]
        object MDG_GetConnectedPackages(EA.Repository Repository);
        ...
        [OperationContract]
        object MDG_GetProperty(EA.Repository Repository, string PackageGuid, string PropertyName);
        ...
        [OperationContract]
        long MDG_Merge(EA.Repository Repository, string PackageGuid, ref object SynchObjects,
        ...
        [OperationContract]
        string MDG_NewClass(EA.Repository Repository, string PackageGuid, string CodeID, ref string Language);
        ...
        [OperationContract]
        long MDG_PostGenerate(EA.Repository Repository, string PackageGuid, string FilePath, string FileContents);
        ...
        [OperationContract]
        long MDG_PostMerge(EA.Repository Repository, string PackageGuid);
        ...
        [OperationContract]
        long MDG_PreGenerate(EA.Repository Repository, string PackageGuid);
        ...
        [OperationContract]
        long MDG_PreMerge(EA.Repository Repository, string PackageGuid);
        ...
        [OperationContract]
        void MDG_PreReverse(EA.Repository Repository, string PackageGuid, object FilePaths);
        ...
        /// <param name="PackageGuid">The GUID identifying the Enterprise Architect package sub-tree that is controlled by the Add-In.</param>
        [OperationContract]
        void MDG_RunExe(EA.Repository Repository, string PackageGuid);
        ...
        [OperationContract]
        long MDG_View(EA.Repository Repository, string PackageGuid, string CodeID);
